...
if (
    (fechaActual.getDate() >= 21 && fechaActual.getMonth() == 11) ||
    fechaActual.getMonth() == 0 ||
    fechaActual.getMonth() == 1 ||
    (fechaActual.getDate() <= 20 && fechaActual.getMonth() == 2)
) {
...
if (
    ...
    (fechaActual.getDate() <= 21 && fechaActual.getMonth() == 5)
) {
...
if (
    ...
    (fechaActual.getDate() <= 23 && fechaActual.getMonth() == 8)
) {
    inner = `<li><img src="./Banners/banner9.png" alt="Banner9"></li>`;
    slider.innerHTML += inner;
}
if (
    (fechaActual.getDate() >= 20 && fechaActual.getMonth() == 8) ||
